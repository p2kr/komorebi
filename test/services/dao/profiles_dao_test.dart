...
void main() {
  ...
  group('ProfilesDao - Basic CRUD', () {
    test('given new profile when insertProfile called then inserts and retrieves profile', () async {
      // Given
    ...
    test('given inactive profile when getAllProfiles called then excludes inactive profile', () async {
      // Given
    ...
    test('given existing profile when deleteProfile called then removes profile from DB', () async {
      // Given
  ...
  group('ProfilesDao - Queries and Streams', () {
    test('given multiple profiles when getLatestProfile called then returns most recently connected profile', () async {
      // Given
    ...
    test('given profile when watchProfile called then emits updates on changes', () async {
      // Given
      final id = await db.profilesDao.insertProfile(
    ...
    test('given profiles when watchLatestProfile called then emits latest profile', () async {
      // Given
      await db.profilesDao.insertProfile(
        ProfilesCompanion.insert(
          username: 'FirstUser',
  ...
  group('ProfilesDao - Conflict resolution and cleanup', () {
    test('given existing profile when insertOrUpdateProfile called with same username then updates existing without duplicating', () async {
      // Given
    ...
    test('given duplicate profiles in DB when cleanDuplicateProfiles called then retains OAuth or latest profile', () async {
      // Given - manually inserting duplicates by avoiding unique constraint or different syncTypes
      await db.profilesDao.insertProfile(
        ProfilesCompanion.insert(
