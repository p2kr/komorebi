...
void main() {
  ...
  group('ConfigsDao Tests', () {
    ...
    test(
      'given key and value when setConfig called then inserts and retrieves config',
      () async {
        // Given
    ...
    test(
      'given existing config when setConfig called with new value then updates config',
      () async {
        // Given
    ...
    test(
      'given existing config when deleteConfig called then removes config',
      () async {
        // Given
        const key = 'TEMP_KEY';
    ...
    test(
      'given multiple configs when getAllConfigs called then returns Map of all configs',
      () async {
        // Given
